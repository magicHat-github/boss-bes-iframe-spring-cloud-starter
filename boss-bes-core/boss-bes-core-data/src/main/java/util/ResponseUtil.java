 ...
 * 分为两种使用情况：
 *  1. 未发生异常，调用buildSuccess(body)方法，应传入希望返还给前端的JSON对象
...
public class ResponseUtil {
     ...
     */
    public static <T> CommonResponse buildSuccess(T body) {
        return new CommonResponse<T>(ResultEnum.SUCCESS, body);
    }
    ...
    public static <T> CommonResponse buildSuccess(String code, String msg, T body) {
        return new CommonResponse<T>(code, msg, body);
    }
    ...
    public static <T> CommonResponse buildError(T body) {
        return new CommonResponse<T>(ResultEnum.DEFAULT_ERROR, body);
    }
    ...
    public static <T> CommonResponse buildError(String code, String msg, T body) {
        return new CommonResponse<T>(code, msg, body);
    }
